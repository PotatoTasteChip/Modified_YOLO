...
if __name__ == '__main__':
    ...
    #model = YOLO('/home/vprism1/modified_YOLO4/runs/train/yolo_vprism_2024010915/weights/last.pt')
    worker = len(os.sched_getaffinity(0)) - 1

    
    # 데이터 증강 설정 추가
    results = model.train(
        data='/home/vprism1/modified_YOLO4/test_code/data_yaml/B_21.yaml',
        epochs=1500,
        batch=15,
        imgsz=640,
        workers=8,
